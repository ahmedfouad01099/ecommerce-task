...
import TaskHeader from '../TaskComponent/TaskHeader';
import {
  ...
  return (
    <View>
      ...
      <View style={styles.modelView}>
        {/* Model header */}
        <TaskHeader customStyles={{ backgroundColor: Colors().light_white }}>
          <TouchableOpacity
        ...
        <View style={styles.filterView}>
          ...
          <TaskDivider size={I18nManager.isRTL === true ? 'sm' : 'md'} />
          <View style={GlobalStyles.horizontalLine}></View>
          <TaskDivider size={I18nManager.isRTL === true ? 'sm' : 'md'} />
