...
function RatingComponent(props) {
  ...
  return (
    <>
      <TaskDivider size={'md'} />
      <Text style={styles.overallTxt}>
        {strings.product_details.overall_rating}
      </Text>
      <TaskDivider size={'sm'} />
      ...
      >
        {strings.product_details.based_on}{' '}
        {reviews != null ? reviews.totalReview : 0}{' '}
        {strings.product_details.review}
      </Text>
      <TaskDivider size={'sm'} />
